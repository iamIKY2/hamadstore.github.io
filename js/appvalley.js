...
myApp.addNotification({
	...
	media: '<img width="44" height="44" style="border-radius:100%" src="https://img.appvalley.vip/icon/994.png">',
	closeOnClick: true,
	onClick: ()=>{
		window.open("itms-services://?action=download-manifest&url=https://appvalley.vip/app/plists/983/install.plist")
	}
});
