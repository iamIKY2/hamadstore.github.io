...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="http://is3.mzstatic.com/image/thumb/Purple128/v4/a9/38/1a/a9381a95-83d1-8bbd-3b89-c8db1bddf796/source/512x512bb.jpg">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Alto's Adventure</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Snowman</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Adventure/Adventure.plist" class="col button button-fill button-round external install"  data-id="188" data-app-name="Alto's Adventure" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
...
<h2 class="header">Description</h2>-Above the placid ivory snow l<div class="desc" style="display: none;">ies a sleepy mountain village,<br />
brimming with the promise of adventure.<br />
</div>
<p>
...
<div class="item-after header">154 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">1.6.2</div>
</div>
</div>
</li>
<li>
