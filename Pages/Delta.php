<div class="page" data-name="install" data-id="220" data-app-name="Delta">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Delta/Delta.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Delta</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Riley Testut</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Delta/Delta.plist" class="col button button-fill button-round external install"  data-id="220" data-app-name="Delta" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
...
<h2 class="header">Description</h2>Delta is a Game Boy Advance <div class="desc" style="display: none;">emulator created by iOS developer Riley Testut using ZodTDD's gpSPhone codebase and runs on iOS devices without the need to jailbreak.</div>
<p>
...
<div class="item-after header">38.9 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">1.0 - beta 4</div>
</div>
</div>
</li>
<li>
