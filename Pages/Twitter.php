<div class="page" data-name="install" data-id="167" data-app-name="Twitter">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Twitter/Twitter.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Twitter ++</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">UnlimApps Inc.</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Twitter/Twitter.plist" class="col button button-fill button-round external install"  data-id="167" data-app-name="Twitter" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://img.appvalley.vip/screenshot/167.png" width="60%">
<h2 class="header">Description</h2>-Tweaked version of Twitter<br />
-<div class="desc" style="display: none;">Sharing Enhancements/<br />
App Integrations/<br />
Additional Enhancements</div>
<p>
...
<div class="item-after header">71.1 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">Tweaked Apps, Tweaked ++ Apps</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">7.24</div>
</div>
</div>
</li>
<li>
