<div class="page" data-name="install" data-id="191" data-app-name="Bike Race Pro">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Bike/Bike.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Bike Race Pro</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Top Fun Driving Games</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Bike/Bike.plist" class="col button button-fill button-round external install"  data-id="191" data-app-name="Bike Race Pro" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://img.appvalley.vip/screenshot/191.png" width="60%">
<h2 class="header">Description</h2>-Unlocks every single bike for<div class="desc" style="display: none;"> Single Player & Multiplayer.<br />
...
<div class="item-after header">68 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">Tweaked Games</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">7.18.1</div>
</div>
</div>
</li>
<li>
