...
<div class="page" data-name="install" data-id="1191" data-app-name="BloonsTD5">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="Apps/BloonsTD5/BloonsTD5.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Bloons TD 5</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Top Fun Driving Games</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/BloonsTD5/BloonsTD5.plist" class="col button button-fill button-round external install"  data-id="1191" data-app-name="BloonsTD5" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://is4-ssl.mzstatic.com/image/thumb/Purple62/v4/b2/56/67/b25667c4-97ea-e2c1-ae0c-e757ee27a4b2/pr_source.png/643x0w.jpg" width="60%">
<h2 class="header">Description</h2>-Five-star tower defense with unrivaled depth<div class="desc" style="display: none;"> and replayability.<br />
-Tourneys & Multiplayer automaticly unlocked.<br />
-Reset button inside tourneys.<br />
-Skip the tourney tutorial. </div>
<p>
...
<div class="item-after header">Top Fun Driving Games</div>
</div>
</div>
</li>
<li>
<div class="item-content">
<div class="item-inner">
<div class="item-title">95.6 MB</div>
...
<div class="item-after header">قسم</div>
</div>
</div>
</li>
<li>
<div class="item-content">
<div class="item-inner">
<div class="item-title">20110</div>
