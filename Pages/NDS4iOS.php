<div class="page" data-name="install" data-id="401" data-app-name="NDS4iOS">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/NDS4iOS/NDS4iOS.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">NDS4iOS</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">unknown</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/NDS4iOS/NDS4iOS.plist" class="col button button-fill button-round external install"  data-id="401" data-app-name="NDS4iOS" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://img.appvalley.vip/screenshot/401.png" width="60%">
<h2 class="header">Description</h2>NDS4iOS is a DS <div class="desc" style="display: none;">emulator created by iOS developer  using ZodTDD's gpSPhone codebase and runs on iOS devices without the need to jailbreak.</div>
<p>
...
<div class="item-after header">unknown</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">1.8 MB</div>
</div>
</div>
</li>
<li>
