<div class="page" data-name="install" data-id="136" data-app-name="PopcornTime">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/PopcornTime/PopcornTime.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">PopcornTime</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">PopcornTimeTV</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/PopcornTime/PopcornTime.plist" class="col button button-fill button-round external install"  data-id="136" data-app-name="PopcornTime" style="background: #5767BE; color: #F5DFC4; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://img.appvalley.vip/screenshot/136.png" width="60%">
<h2 class="header">Description</h2>-Watch free movies and TV Show<div class="desc" style="display: none;">s on your device with PopcornTime for iOS!</div>
<p>
...
<div class="item-after header">PopcornTimeTV</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">39.7 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">Movies on iOS</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">3.2.19</div>
</div>
</div>
</li>
<li>
