<div class="page" data-name="install" data-id="712" data-app-name="YouTube ++">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/Hamadstore/HamadStore.github.io/master/Apps/YouTube/YouTube.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">YouTube ++</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">UnlimApps Inc.</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/Hamadstore/HamadStore.github.io/master/Apps/YouTube/YouTube.plist" class="col button button-fill button-round external install"  data-id="712" data-app-name="YouTube ++" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://raw.githubusercontent.com/Hamadstore/HamadStore.github.io/master/Apps/YouTube/YouTubeP.png" width="60%">
<h2 class="header">Description</h2>*nothing<div class="desc" style="display: none;">!<br />
-Download Videos<br />
-Import ti Library<br />
-Block Ads<br />
-Free to use</div>
<p>
...
<div class="item-after header">62.2 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">13.20.13</div>
</div>
</div>
</li>
<li>
