<div class="page" data-name="install" data-id="11236" data-app-name="Infuse">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="Apps/Infuse/Infuse.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Infuse</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Firecore, LLC</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Infuse/Infuse.plist" class="col button button-fill button-round external install"  data-id="11236" data-app-name="Infuse" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://is2-ssl.mzstatic.com/image/thumb/Purple125/v4/88/c0/83/88c083c0-43ff-cb87-e85d-2ebd1f0b591e/mzl.qebbjceo.png/230x0w.jpg" width="60%">
<h2 class="header">Description</h2>-Watch free movies and TV Show<div class="desc" style="display: none;">s on your device with Infuse for iOS!</div>
<p>
...
<div class="item-after header">Firecore, LLC</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">25 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">Entertainment</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">3.7.2</div>
</div>
</div>
</li>
<li>
