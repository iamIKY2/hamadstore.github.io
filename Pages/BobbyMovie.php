<div class="page" data-name="install" data-id="136" data-app-name="BobbyMovie">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/BobbyMovie/BobbyMovie.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Bobby Movie</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">BobbyMovie</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/BobbyMovie/BobbyMovie.plist" class="col button button-fill button-round external install"  data-id="136" data-app-name="BobbyMovie" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/BobbyMovie/Preview.png" width="60%">
<h2 class="header">Description</h2>-Watch free movies and TV Show<div class="desc" style="display: none;">s on your device with BobbyMovie for iOS!</div>
<p>
...
<div class="item-after header">BobbyHDApp</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">6.1 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">3.2.5</div>
</div>
</div>
</li>
<li>
