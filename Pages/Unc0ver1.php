<div class="page" data-name="install" data-id="622" data-app-name="Unc0ver1”>
...
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Unc0ver 1</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Pwn20wnd</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Unc0ver/Unc0ver1.plist" class="col button button-fill button-round external install"  data-id="622" data-app-name="Unc0ver1” style="background: #F4F4F6; color: #000000; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
...
<div class="item-after header">3.0.0 B38</div>
</div>
</div>
<div class="item-content">
<div class="item-inner">
