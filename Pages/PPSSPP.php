<div class="page" data-name="PPSSPP" data-id="26" data-app-name="PPSSPP">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/PPSSPP/PPSSPP.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">PPSSPP [64bit]</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">PPSSPP</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/PPSSPP/PPSSPP.plist" class="col button button-fill button-round external install"  data-id="2" data-app-name="PPSSPP" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/PPSSPP/PPSSPPp.png" width="60%">
<h2 class="header">Description</h2>-What's new in 1.6.1 <div class="desc" style="display: none;">y. <br />
* Crashfixes<br />
* Fix broken graphics in flOw<br />
-Night Mod <br />
<br />
...
<div class="item-after header">PPSSPP</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">11.8 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">1.6.1-4</div>
</div>
</div>
</li>
<li>
