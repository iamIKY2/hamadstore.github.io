<div class="page" data-name="install" data-id="1131" data-app-name="houdini">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Houdini/Houdini.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;"> Houdini </div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Abraham Masri @cheesecakeufo</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Houdini/Houdini.plist" class="col button button-fill button-round external install"  data-id="1131" data-app-name="houdini" style="background: #2498C4; color: #E2F8FF; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Houdini/HoudiniP.png" width="60%">
...
<div class="item-after header">Abraham Masri @cheesecakeufo</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">1.4 MB</div>
</div>
</div>
</li>
<li>
