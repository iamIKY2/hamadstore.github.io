...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Electra/Electra.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Electra</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Electra Team</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Electra/Electra.plist" class="col button button-fill button-round external install"  data-id="466" data-app-name="Electra" style="background: #445466; color: #FFFFFF; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Electra/PElectra.png" width="60%">
<h2 class="header">Description</h2>Electra is a free jailbreak tool for iOS 11.0 - 11.4.1.<div class="desc" style="display: none;"><br />
<br />
Changelogs:<br />
<br />
1.3.0:<br />
