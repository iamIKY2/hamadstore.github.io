<div class="page" data-name="snapchat" data-id="145" data-app-name="Snapchat ++">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://is5-ssl.mzstatic.com/image/thumb/Purple118/v4/30/30/07/303007dc-b078-24e1-35cd-d9e175effaaf/AppIcon-1x_U007emarketing-0-0-GLES2_U002c0-512MB-sRGB-0-0-0-85-220-0-0-0-4.png/230x0w.jpg">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Snapchat ++</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">UnlimApps Inc.</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Snapchat/Snapchat.plist" class="col button button-fill button-round external install"  data-id="145" data-app-name="Snapchat ++" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="http://moreinfo.thebigboss.org/moreinfo/appplusforsnapchat3.jpg" width="60%">
<h2 class="header">Description</h2>-Delete the original Snapchat <div class="desc" style="display: none;">first. <br />
-Tweaked version of Snapchat<br />
New update for Snapchat ++:<br />
-Disable new Snapchat UI option <br />
-Night Mod <br />
<br />
* Activate video recording 6 consecutive snaps <br />
for some accounts where this feature is not available<br />
* Add a passcode to protect the application<br />
* Add the Groups icon on the Home screen<br />
*Fixes some problems with the new Snapchat update<br />
-Always keep Snaps<br />
-Show Timer Stories<br />
-Upload Photo & Video of Gallery<br />
-Incognito in Watching Stories<br />
-Disable Screenshot<br />
-Disable Discovery<br />
-Change your Location<br />
-Groups of Friends<br />
-Custom Filters<br />
-Image Editor<br />
-50 sec Video Recording<br />
-Long Tap to Record Videos<br />
-Save from within groups<br />
-Save to Custom Album</div>
<p>
...
<div class="item-after header">100.24 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">Tweaked ++ Apps, Featured</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">1.7r-51</div>
</div>
</div>
</li>
<li>
