<div class="page" data-name="install" data-id="695" data-app-name="Provenance">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Provenance/Provenance.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Provenance</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Provenance</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Provenance/Provenance.plist" class="col button button-fill button-round external install"  data-id="695" data-app-name="Provenance" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Provenance/ProvenanceP.png" width="60%">
<h2 class="header">Description</h2>Provenance is a poweful multi-<div class="desc" style="display: none;">emulator that currently supports Sega Genesis, Sega Master System, Game Gear, and SNES games (with many more systems to come) on all updated devices with the latest iOS. It was created by talented developer James Addyman (@jasarien). </div>
<p>
...
<div class="item-after header">Provenance</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">24 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">Emulators</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">1.5</div>
</div>
</div>
</li>
<li>
