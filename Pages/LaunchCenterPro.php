<div class="page" data-name="install" data-id="110" data-app-name="Launch Center Pro">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://is3-ssl.mzstatic.com/image/thumb/Purple118/v4/a2/4c/d0/a24cd0ab-3fac-9d95-9960-7eb8a6b3343a/source/512x512bb.jpg">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Launch Center Pro</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Contrast</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/Hamadstore/HamadStore.github.io/master/Apps/LaunchCenterPro/LaunchCenterPro.plist" class="col button button-fill button-round external install"  data-id="110" data-app-name="Launch Center Pro" style="background: #2779EF; color: #FFFFFF; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://is4-ssl.mzstatic.com/image/thumb/Purple118/v4/50/15/78/501578ae-710c-1b96-d9a2-b04833e129f0/pr_source.png/230x0w.jpg" width="60%">
<h2 class="header">Description</h2>-Launcher Pro.<div class="desc" style="display: none;"></div>
<p>
...
<div class="item-after header">57.7 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">Productivity</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">2.9</div>
</div>
</div>
</li>
<li>
