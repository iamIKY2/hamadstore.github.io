<div class="page" data-name="install" data-id="1946" data-app-name="TouchRetouch">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/TouchRetouch/TouchRetouch.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">TouchRetouch</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Adva-Soft</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/TouchRetouch/TouchRetouch.plist" class="col button button-fill button-round external install"  data-id="12466" data-app-name="TouchRetouch" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/TouchRetouch/TouchRetouchP.png" width="60%">
<h2 class="header">Description</h2>4.1.8:<br />
Made additional improvements providing for a better compati<div class="desc" style="display: none;">bility with iPhone X in Photos Extension.<br />
Made minor fixes and improvements.<br />
4.1.7:<br />
Made the app compatible with the Invert Colors feature.<br />
Made minor fixes and improvements.<br />
<p>
...
<div class="item-after header">Adva-Soft</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">24.2 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">Photo & Video</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">4.1.8</div>
</div>
</div>
</li>
<li>
