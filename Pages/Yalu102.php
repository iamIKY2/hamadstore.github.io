<div class="page" data-name="install" data-id="466" data-app-name="Yalu102">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Yalu102/Yalu102.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Yalu102</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">qwertyoruiop</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Yalu102/Yalu102.plist" class="col button button-fill button-round external install"  data-id="466" data-app-name="Yalu102" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Yalu102/Yalu102P.png" width="60%">
<h2 class="header">Description</h2>-Jailbreak for iOS 10.0.1-10.2<div class="desc" style="display: none;">. <br />
-For all iOS 10 64 bit devices except iPhone 7 and iPhone 7+. </div>
<p>
...
<div class="item-after header">qwertyoruiop</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">7.9 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">beta 7</div>
</div>
</div>
</li>
<li>
