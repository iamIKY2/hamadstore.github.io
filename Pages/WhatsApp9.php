<div class="page" data-name="install" data-id="212” data-app-name="WhatsApp9”>
...
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">WhatsApp 9</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">WhatsApp Inc.</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/WhatsApp/WhatsApp9.plist" class="col button button-fill button-round external install"  data-id="612" data-app-name="WhatsApp2O" style="background: #16C333; color: #FFFFFF; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
