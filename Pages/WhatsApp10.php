<div class="page" data-name="install" data-id=“412” data-app-name="WhatsApp10”>
...
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">WhatsApp 10</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">WhatsApp Inc.</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/WhatsApp/WhatsApp10.plist" class="col button button-fill button-round external install"  data-id="612" data-app-name="WhatsApp2O" style="background: #16C333; color: #FFFFFF; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
...
<h2 class="header">Description</h2>WhatsApp 2 Original is WhatsApp<div class="desc" style="display: none;"><br />
<br />
Changelogs:<br />
<br />
1.3.0:<br />
...
<div class="item-after header">2.19.31</div>
</div>
</div>
<div class="item-content">
<div class="item-inner">
