<div class="page" data-name="install" data-id="339" data-app-name="Geekbench 4">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Geekbench/Geekbench.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Geekbench 4</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Primate Labs Inc.</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Geekbench/Geekbench.plist" class="col button button-fill button-round external install"  data-id="339" data-app-name="Geekbench 4" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://img.appvalley.vip/screenshot/339.png" width="60%">
<h2 class="header">Description</h2>Geekbench provides a comprehen<div class="desc" style="display: none;">sive set of benchmarks engineered to quickly and accurately measure processor and memory performance. Designed to make benchmarks easy to run and easy to understand, Geekbench takes the guesswork out of producing robust and reliable benchmark results.</div>
<p>
...
<div class="item-after header">Primate Labs Inc.</div>
</div>
</div>
</li>
<li>
<div class="item-content">
<div class="item-inner">
<div class="item-title">58.7 MB</div>
<div class="item-after header">الحجم</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">Paid and Other Apps, Paid and Other Apps</div>
</div>
</div>
</li>
<li>
<div class="item-content">
<div class="item-inner">
<div class="item-title">4.2.3</div>
<div class="item-after header">اصدار</div>
</div>
</div>
</li>
<li>
