...
<div class="page" data-name=“Cute” data-id="75" data-app-name="Cute Cut Pro">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://is5-ssl.mzstatic.com/image/thumb/Purple128/v4/83/df/68/83df6818-ce29-cfde-790c-1b81e240f8dc/source/512x512bb.jpg">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Cute Cut Pro</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">YU BO</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Cute/Cute.plist" class="col button button-fill button-round external install"  data-id="75" data-app-name="Cute Cut Pro" style="background: #000000; color: #FFFFFF; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://img.appvalley.vip/screenshot/75.png" width="60%">
<h2 class="header">Description</h2>-Now, you can DRAW movies, AND<div class="desc" style="display: none;"> you can draw ON movies! Cute CUT is powerful, easy-to-use editing features put YOU in control, allowing you to make the highest quality movies, DIFFERENT from anything you have seen!</div>
<p>
...
<div class="item-after header">YU BO</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">39.37 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">Apps</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">1.8.9</div>
</div>
</div>
</li>
<li>
