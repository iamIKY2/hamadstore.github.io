<div class="page" data-name="install" data-id="74" data-app-name="Crunchyroll++">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="Apps/Crunchyroll/Crunchyroll.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Crunchyroll ++</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Ellation, Inc.</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Crunchyroll/Crunchyroll.plist" class="col button button-fill button-round external install"  data-id="74" data-app-name="Crunchyroll++" style="background: #F47521; color: #FFFFFF; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/Crunchyroll/CrunchyrollP.png" width="60%">
<h2 class="header">Description</h2>- Crunchyrol<div class="desc" style="display: none;">l ++ app first<br />
-Please use Just Explore option, otherwise, the app will crash<br />
-Premium Unlocked ps: except videos</div>
<p>
...
<div class="item-after header">Ellation, Inc.</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">16.8 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">تطبيقات مدموجه</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">3.2.0</div>
</div>
</div>
</li>
<li>
