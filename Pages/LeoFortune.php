<div class="page" data-name="install" data-id="348" data-app-name="Leo's Fortune">
...
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/Hamadstore/HamadStore.github.io/master/Apps/LeoFortune/LeoFortune.plist" class="col button button-fill button-round external install"  data-id="348" data-app-name="Leo's Fortune" style="background: #F6F8D3; color: #369261; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://is2-ssl.mzstatic.com/image/thumb/Purple128/v4/22/04/c4/2204c455-c9dd-b858-2050-38f014b30d97/pr_source.jpg/643x0w.jpg" width="60%">
<h2 class="header">Description</h2>App Store Best of 2014 and 201<div class="desc" style="display: none;">4 WWDC Apple Design Award winner!<br />
<br />
Leoâ€™s Fortune is a platform adventure game where you hunt down the cunning and mysterious thief that stole your gold. Beautifully hand-crafted levels bring the story of Leo to life in this epic adventure. </div>
<p>
...
<div class="item-after header">1337 & Senri LLC</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">150.6 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">1.0.8</div>
</div>
</div>
</li>
<li>
