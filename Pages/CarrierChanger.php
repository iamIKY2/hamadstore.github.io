<div class="page" data-name="install" data-id="11131" data-app-name="CarrierChanger">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/CarrierChanger/CarrierChanger.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;"> CarrierChanger </div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Ian beer</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/CarrierChanger/CarrierChanger.plist" class="col button button-fill button-round external install"  data-id="11131" data-app-name="houdini" style="background: #007AFF; color: #F0F1F6; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/CarrierChanger/CarrierChanger.png" width="60%">
<h2 class="header">Description</h2>-Jailbreak for iOS 11.0 - 11.3.1<div class="desc" style="display: none;">. <br />
...
<div class="item-after header">Ian beer</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">153 KB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">multi_path</div>
</div>
</div>
</li>
<li>
