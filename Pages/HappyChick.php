<div class="page" data-name="install" data-id="229" data-app-name="Happy Chick">
...
<div class="row">
<div class="col-40">
<img width="100%" style="border-radius:25%;" src="Apps/HappyChick/HappyChick.png">
</div>
<div class="col-60">
<h2 class="header" style="padding:0px;"><div id="#appName" style="overflow:hidden;">Happy Chick</div><br><div style="margin-top:-35px; font-size:18px;"><small style="color:#6d6d72;">Unknown</small></div></h2>
<a href="itms-services://?action=download-manifest&url=https://raw.githubusercontent.com/HamadStore/HamadStore.github.io/master/Apps/HappyChick/HappyChick.plist" class="col button button-fill button-round external install"  data-id="229" data-app-name="Happy Chick" style="background: #03C7F8; color: #FFF200; font-weight:bold; width: 72px;">تثبيت</a>
</div>
</div>
</div>
<div class="content-block" style="max-width:414px; text-align:left;">
<h2 class="header">Preview</h2>
<img style="border-radius:9px; max-width:414px;" src="https://img.appvalley.vip/screenshot/229.png" width="60%">
<h2 class="header">Description</h2>-No subscription needed<br />
...
<div class="item-after header">78.7 MB</div>
</div>
</div>
</li>
<li>
...
<div class="item-after header">1.5.6.3</div>
</div>
</div>
</li>
<li>
